...
namespace StudioStudio_Server.Models.DTOs.Request
{
    ...
    public class UpdateSubscriptionPlanRequest
    {
        ...
        [Required(ErrorMessage = ErrorCodes.ValidationRequiredField)]
        [StringLength(100, ErrorMessage = ErrorCodes.ValidationRequiredField)]
        public string PlanName { get; set; } = null!;

        [Required(ErrorMessage = ErrorCodes.ValidationRequiredField)]
        [Range(0, double.MaxValue, ErrorMessage = ErrorCodes.ValidationRequiredField)]
        ...
        [Required(ErrorMessage = ErrorCodes.ValidationRequiredField)]
        [Range(1, int.MaxValue, ErrorMessage = ErrorCodes.ValidationRequiredField)]
        ...
        [Required(ErrorMessage = ErrorCodes.ValidationRequiredField)]
        [Range(0, int.MaxValue, ErrorMessage = ErrorCodes.ValidationRequiredField)]
