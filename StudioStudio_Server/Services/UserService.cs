...
namespace StudioStudio_Server.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task ChangePasswordAsync(Guid userId, ChangePasswordRequest request)
        {
            ...
            {
                throw new AppException(ErrorCodes.AuthPasswordMismatch, StatusCodes.Status400BadRequest);
            }
        ...
        private async Task<string> SaveAvatarAsync(Guid userId, IFormFile file, string? existingAvatarUrl)
        {
            ...
            {
                throw new AppException("File size exceeds 5MB limit", StatusCodes.Status400BadRequest);
            }
            ...
            {
                throw new AppException("Invalid file format. Only image files are allowed", StatusCodes.Status400BadRequest);
            }
